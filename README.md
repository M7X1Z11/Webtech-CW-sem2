This web application that uses CRUD operations to add delete and update and also read the data which is events this whole website is built to serve as 
